...
import { CheckCircle, ChevronRight, Clock, FileText, Mail, MapPin, Phone, Shield, Stethoscope, User } from 'lucide-react';
                                    ...
                                    <div className="card-premium p-8 md:p-12">
                                          ...
                                          {step === 2 && (
                                                <div>
                                                      ...
                                                      <div className="mb-6"><label className="block text-sm font-medium text-gray-700 mb-2">Describe Your Condition (Optional)</label>
                                                            <textarea value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} rows={6}
                                                                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500" placeholder="Please describe your medical condition, requirements, preferred dates, or any questions you may have..." /></div>
